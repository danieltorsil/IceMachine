...
qiime2input.py -i /media/darwin/Proyectos/2022/MP_02_2019/16S/QIIME2/fastq/ > Manifest
...
qiime feature-classifier classify-sklearn --i-classifier /media/darwin/Externo/DanielTS/BBDD/silva-138-99-nb-classifier.qza --i-reads ./rep-seqs.qza --verbose --p-n-jobs 16 --o-classification ./taxonomy.qza
